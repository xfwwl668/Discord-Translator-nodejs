...
const UUID = process.env.UUID || 'cb4a2c65-ac5e-4bc2-8cf8-4d79de8d418b'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'lumixcore668.xfwwl.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMjA3ZmVmNzA5MjkyMTkyNWZiNDVmNDRhYWVhMmViNmYiLCJ0IjoiNWRlNWE0ZWQtMTRlMy00OGM3LTlmZTYtMjM5NWMxZmZkMWNlIiwicyI6IlpHRTRZak00WmpRdFptVmtaQzAwWTJFMExXRmlNakl0TVdZellUQXhaVFExTmpZeiJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 3000;            // 固定隧道端口,需和PORT一致
const CFIP = process.env.CFIP || 'www.dbs.com';        // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'lumixcore_h_';                        // 节点名称
